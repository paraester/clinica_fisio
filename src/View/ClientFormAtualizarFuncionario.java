...
public class ClientFormAtualizarFuncionario extends JPanel implements VisualWindow {
	...
	public ClientFormAtualizarFuncionario(MainFrame telainit, Register register) {
	...
	public void setupComponentes() {
		nomedoformulario = new JLabel(" <em construçao> ATUALIZAR INFORMAÇÕES <em construçao> ");
		...
		nomeCampo.setBounds(400, 90, 300, 20);
		...
		/*
		 * btcadastro.setBackground(Color.white); btcadastro.setOpaque(true);
		 ...
		 * btcadastro.setBorder(javax.swing.BorderFactory.createLineBorder(new
		 * Color(255, 255, 225), 2));
		 */
